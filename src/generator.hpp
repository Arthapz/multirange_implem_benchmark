...
namespace std {
    ...
    namespace ranges {
        template<class _T, typename _U, typename _Alloc>
    ...
    class __promise_base_alloc {
      ...
      public:
        ...
        static void* operator new(std::size_t __frameSize,
                                  _This&,
                                  std::allocator_arg_t,
                                  _Alloc __alloc,
                                  _Args&...) {
            return __promise_base_alloc::operator new(__frameSize,
                                                      std::allocator_arg,
                                                      std::move(__alloc));
        }
    ...
    struct coroutine_traits<generator<_Ref, _Value>, allocator_arg_t, _Alloc, _Args...> {
      ...
      public:
        using promise_type = __generator_promise<generator<_Ref, _Value>,
                                                 __byte_allocator,
